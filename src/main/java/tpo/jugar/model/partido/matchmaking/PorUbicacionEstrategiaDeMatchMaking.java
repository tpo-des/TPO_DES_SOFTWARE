...
public class PorUbicacionEstrategiaDeMatchMaking implements EstrategiaDeMatchMaking {


    @Override
    public Partido matchearCon(PartidoService service, Usuario usuario) {
        Optional<Partido> partidos = service.findNecesitadosDeJugadoresBy(usuario.getUbicacion())
                .stream().findFirst();
